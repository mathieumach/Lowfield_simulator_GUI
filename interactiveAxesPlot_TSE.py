...
class interactivePlot(object):   
    def __init__(self,fig, ax, X, TR, TE, T1, T2, c, ETL, trajectory, M0, B1, noise, data_mat, plotAxis = 2, axisLabels = None, fov = None, cmap = 'gray'):
...
#        set various event handlers
        ...
        if self.traj == 'Out-in' or self.traj == 'Linear':      
            ...
            def update(val):
                ...
                if te < tr:
                    self.X = TSE_seq(tr, te, etl, self.M0, self.T1, self.T2, self.c, self.traj)
