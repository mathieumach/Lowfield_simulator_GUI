...
class interactivePlot(object):   
    def __init__(self,fig, ax, X, TR, TE, TI, T1, T2, M0, B1, noise, data_mat, plotAxis = 2, axisLabels = None, fov = None, cmap = 'gray'):
...
#        set various event handlers
        ...
        # TI
        self.axSlider_TI = fig.add_axes([0.15, 0.02, 0.6, 0.03])
        ...
        def update(val):               
            ...
            if te < tr:
                self.X = np.multiply(IN_seq(tr, te, ti, self.T1, self.T2, self.M0), self.B1)
