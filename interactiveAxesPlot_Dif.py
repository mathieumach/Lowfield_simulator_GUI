...
class interactivePlot(object):   
    def __init__(self,fig, ax, X, TR, TE, T1, T2, M0, b, D, B1, noise, data_mat, plotAxis = 2, axisLabels = None, fov = None, cmap = 'gray'):
...
#        set various event handlers
        ...
        def update(val):
            ...
            if te < tr:
                self.X = np.multiply(Diffusion_seq(tr, te, self.T1, self.T2, self.M0, b, self.D),B1)
